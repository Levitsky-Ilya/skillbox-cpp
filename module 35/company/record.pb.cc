...
const char descriptor_table_protodef_record_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014record.proto\"\202\001\n\006Record\022\027\n\017yearEstabli"
  "shed\030\001 \002(\005\022\024\n\014legalAddress\030\002 \002(\t\022\014\n\004name"
  "\030\003 \002(\t\022\022\n\noccupation\030\004 \001(\t\022\'\n\037performsFo"
  "reignEconomicActivity\030\005 \001(\010"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_record_2eproto = {
  false, false, 147, descriptor_table_protodef_record_2eproto, "record.proto", 
...
class Record::_Internal {
 public:
  ...
  static void set_has_yearestablished(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
  ...
  static void set_has_performsforeigneconomicactivity(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Record::Record(const Record& from)
  ...
  ::memcpy(&yearestablished_, &from.yearestablished_,
    static_cast<size_t>(reinterpret_cast<char*>(&performsforeigneconomicactivity_) -
    reinterpret_cast<char*>(&yearestablished_)) + sizeof(performsforeigneconomicactivity_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&yearestablished_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&performsforeigneconomicactivity_) -
    reinterpret_cast<char*>(&yearestablished_)) + sizeof(performsforeigneconomicactivity_));
}
...
// @@protoc_insertion_point(message_clear_start:Record)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&yearestablished_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&performsforeigneconomicactivity_) -
        reinterpret_cast<char*>(&yearestablished_)) + sizeof(performsforeigneconomicactivity_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          _Internal::set_has_yearestablished(&has_bits);
          yearestablished_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Record.legalAddress");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          _Internal::set_has_performsforeigneconomicactivity(&has_bits);
          performsforeigneconomicactivity_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Record::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->_internal_yearestablished(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_performsforeigneconomicactivity(), target);
  }
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:Record)
  ...
  if (_internal_has_yearestablished()) {
    // required int32 yearEstablished = 1;
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_yearestablished());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Record)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      yearestablished_ = from.yearestablished_;
    }
    if (cached_has_bits & 0x00000010u) {
      performsforeigneconomicactivity_ = from.performsforeigneconomicactivity_;
    }
...
void Record::InternalSwap(Record* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Record, performsforeigneconomicactivity_)
      + sizeof(Record::performsforeigneconomicactivity_)
      - PROTOBUF_FIELD_OFFSET(Record, yearestablished_)>(
          reinterpret_cast<char*>(&yearestablished_),
          reinterpret_cast<char*>(&other->yearestablished_));
}
